        ...
        <Box m="20px">
          {isTeam && (
            <div className="w-full flex justify-end">
              <div
                className={`${styles.button} !w-[200px] !rounded-full dark:bg-black !h-[35px] dark:border dark:border-[#ffffff6c]`}
          ...
          <Box
            ...
            sx={{
              ...
              "& .MuiDataGrid-columnHeaders": {
                backgroundColor: theme === "dark" ? "#178582" : "#A4A9FC",
                borderBottom: "none",
                color: theme === "dark" ? "#fff" : "#000",
              },
            ...
            >
              <Box className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[450px] bg-white dark:bg-slate-900 rounded-[8px] shadow p-4 outline-none">
                ...
                <div className="mt-4">
                  ...
                  >
                    <option value="admin" className="dark:text-black text-black">Admin</option>
                    <option value="user" className="dark:text-black text-black">User</option>
                  </select>
                  <br />
                  <div
