  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">Sapphire Sync?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than Sapphire Sync, the premier programming community dedicated
          to helping new programmers achieve their goals and reach their full
          potential.
          <br />
          <br />
          As the founder and CEO of Sapphire Sync, I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created Sapphire Sync &ndash; to provide new programmers
          ...
          <br />
          <br />
          At Sapphire Sync, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But Sapphire Sync is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With Sapphire Sync by your side, there&apos;s nothing standing between you
          ...
          <br />
          <br />
          So what are you waiting for? Join the Sapphire Sync family today and let&apos;s
        ...
        <br />
        <span className="text-[22px]">Draco</span>
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of Sapphire Sync
        </h5>
        <br />
        <br />
        <br />
